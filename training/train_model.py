...
try:
    ...
    print("Por favor, mova o arquivo exportado para a pasta principal do projeto.")
    raise SystemExit(1)
...
history = model.fit(features, targets, epochs=30, batch_size=32, validation_split=0.15, shuffle=True)
